...
<div class="container">
        <form action="signup_process.php" method="POST" >
            ...
            <div class="form-group">
                        <input type="password" class="form-control" name="password" placeholder="Enter your Password" size="10">
                        <small id="pass" class="form-text text-muted">Password must be 8 character long</small>
